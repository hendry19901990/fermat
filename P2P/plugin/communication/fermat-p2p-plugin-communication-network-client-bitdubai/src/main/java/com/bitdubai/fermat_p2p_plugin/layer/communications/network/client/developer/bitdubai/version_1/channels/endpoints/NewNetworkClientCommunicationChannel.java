 ...
 * @since Java JDK 1.7
 */
public class NewNetworkClientCommunicationChannel extends Endpoint {
    ...
    public NewNetworkClientCommunicationChannel(final NetworkClientCommunicationConnection connection,
